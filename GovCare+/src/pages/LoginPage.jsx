      ...
      <div className={`login-page${darkMode ? ' dark' : ''}`}>
        <div className="login-container">
          ...
          <form onSubmit={handleSubmit}>
              ...
              <div className="robot-check" onClick={handleRobotClick}>
                ...
                <div className="robot-check-badge">
                  <div style={{display:'flex',flexDirection:'column',alignItems:'center',gap:1}}>
                    <img src={recaptchaLogo} alt="reCAPTCHA" width="32" height="32" draggable={false}/>
                    <span style={{color:'#555',fontSize:6.5,fontWeight:700,letterSpacing:0.4,lineHeight:1,fontFamily:'Arial,sans-serif'}}>reCAPTCHA</span>
                    <span style={{color:'#aaa',fontSize:5.5,lineHeight:1,fontFamily:'Arial,sans-serif'}}>Privacy · Terms</span>
                  </div>
                  <span>Protected</span>
                </div>
              </div>
            ...
            <button type="submit" className={`btn-login-submit${loading ? ' loading' : ''}`} disabled={loading || !notRobot}>
