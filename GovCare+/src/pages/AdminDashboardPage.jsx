...
import EncryptionReportPage from './EncryptionReportPage';
...
export default function AdminDashboardPage() {
  ...
  Citizen: ${c.citizen} | ${c.email}`)];
    ...
    if (activeNav === 'encryption-report')
      return <EncryptionReportPage darkMode={darkMode} />;
        ...
        <div className="admin-layout">
          ...
          <div className={`admin-sidebar${sidebarOpen ? ' open' : ''}`}>
            ...
            <ul className="sidebar-nav">
              ...
              <SidebarLink id="encryption-report" label="Encryption Report" icon={<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>} />
